...
>(({ className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-y-0 right-0 z-50 flex h-full w-full max-w-lg flex-col border-l border-[var(--border)] bg-[var(--surface)] shadow-xl",
...
function SheetHeader({
  ...
  return (
    <div
      className={cn("flex flex-col gap-1 border-b border-[var(--border)] px-5 py-4 pr-12", className)}
      {...props}
    />
  );
}
